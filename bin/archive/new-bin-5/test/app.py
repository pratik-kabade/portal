...
# llm1.rag_model('/m.pdf', 'what is this document about?')
llm1.rag_model('/m.pdf', 'give me steps to create a condtion using Conditional Expression Manager scenario')
# llm1.rag_model('/m.pdf', 'what is the Integration Framework?')
