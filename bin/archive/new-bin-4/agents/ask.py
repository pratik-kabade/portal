...
def ask():
    ...
    #print(f"source of the document is {response.get_formatted_sources()}")
    #print(f"metadata :{response['metadatas']}")
    ...
    #print(f"source of the document is {final_response.get_formatted_sources()}")
