...
general_agent = Agent(
    ...
    backstory = """You are an AI assistant that will follow these rules:
    - Understand when to implement jira function.
    - Understand when to create and read data from the database.
    - Understand when to use llm function.""",
